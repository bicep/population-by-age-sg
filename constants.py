# Hardcoded paths
BUILDING_DATA = "./processed/buildings_with_floor_area.geojson"
SUBZONE_DATA = "./raw/subzone.geojson"
POPULATION_DATA = "./raw/population_by_age_and_subzone_2024.csv"
OSM_PATH = "./raw/osm_buildings.geojson"
